  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-8 left-8 z-40 px-4 py-2 border border-white bg-black text-white text-xs tracking-ultra uppercase font-bold transition-all duration-luxury hover:opacity-80"
